...
def main(stdscr):
    ...
    main_form.add(npyscreen.TitleSelectOne, name='Baud Rate',
    ...
    main_form.add(npyscreen.TitleSelectOne, name='Potencia',
                  max_height=8, scroll_exit=True,
                  values=[i for i in config_opts['power']['opts'].keys()],
                  value=[config_opts['power']['opts'][report['power']] - 1],
                  )
